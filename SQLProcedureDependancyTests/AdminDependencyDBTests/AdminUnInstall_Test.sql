...
--)
--	SET @V_Message = @V_Message + 'AutoCreatedLocal' + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_ParametersTypeName + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_LoginName + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_SchemaName + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_UserName + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_QueueName + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_ServiceName + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_SubscribersTableName + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_InstallProcedureName + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_ReceiveProcedureName + ' does exists. ';
...
IF EXISTS (
	...
	SET @V_Message = @V_Message + @V_UninstallProcedureName + ' does exists. ';
